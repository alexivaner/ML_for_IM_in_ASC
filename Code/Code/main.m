...
fprintf('Baseline system throughput in average: %f \n', C_all_on_avg);
fprintf('APC system throughput in average: %f \n', C_APC_avg);
fprintf('Improvement is: %f % \n', ((C_APC_avg-C_all_on_avg)/C_all_on_avg)*100);
